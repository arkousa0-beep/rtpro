      ...
      >
        <CardContent className="p-4 pr-5 pl-3 flex items-center justify-between">
          <div className="flex items-center gap-4 flex-1">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-white/5 to-white/[0.02] flex items-center justify-center border border-white/5 shrink-0 group-hover:bg-primary/5 transition-colors">
